...
public class GabaritoResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<GabaritoDTO> update(@PathVariable Long id, @RequestBody GabaritoDTO dto){
		dto = gabaritoService.update(id,dto);
	...
	public ResponseEntity<GabaritoDTO> delete(@PathVariable Long id){
		gabaritoService.delete(id);
