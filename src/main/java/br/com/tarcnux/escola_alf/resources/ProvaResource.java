...
public class ProvaResource {
	...
	@PostMapping
	public ResponseEntity<ProvaDTO> insert(@RequestBody ProvaDTO dto){
		dto = provaService.insert(dto);
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ProvaDTO> update(@PathVariable Long id, @RequestBody ProvaDTO dto){
		dto = provaService.update(id,dto);
